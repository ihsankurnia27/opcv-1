...
?>
    <tr>
        ...
        <td>
            ...
            <!-- BUAT WR -->
            <a href="indexut2.php"target="_blank"class="btn btn-info btn-sm ml-1">Buat WR</a>
...
<script>
    ...
    // ============= AUTO-LOAD x HARI TERAKHIR UNTUK POINT LT-1101 SAAT HALAMAN DIBUKA =============
    $(document).ready(function () {
        ...
        var past = new Date();
        past.setDate(today.getDate() - 6); // 6 hari sebelumnya -> total 7 hari termasuk hari ini
