...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="export_recent_excel.php" class="btn btn-success btn-sm">
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="export_bydate_excel.php?tanggal_filter=<?= urlencode($tanggal_filter); ?>"
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="export_by_point_excel.php?point_filter=<?= urlencode($point_filter); ?>&from_date=<?= urlencode($from_date); ?>&to_date=<?= urlencode($to_date); ?>"
                       class="btn btn-success btn-sm">
                        <i class="fa fa-file-excel"></i> Export Excel
                    </a>
                </div>
